...
// let selektAdc = document.querySelector("#sc-selekt");
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
        <div class="card card-img">
          ...
          <div class="card-body">
            ...
            >Delete</button>
            <a class="btn button-a btn-primary" href="student.html?teacher=${id}">See Student ${id}</a>
          </div>
        </div>
      </div>`;
}

// loder end teacher card
const selektAdc = document.getElementById("asc-selekt");

selektAdc.addEventListener("change", function () {
  const selectedValue = this.value;
  order = selectedValue; // O'zgaruvchini global darajada yangilash
